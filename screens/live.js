...
export default class Live extends Component {
  state = {
    ...
    meetingTitle: '',
    userName: '',
    userEmail: 'remifrank49@gmail.com',
    userId: '',
    accessToken: '',
    userZoomAccessToken: '',
  ...
  async all() {
    console.warn('........');
    await this.setState({meetingCreated: false});
  ...
  async componentDidMount() {
    ...
    this.focusListener = navigation.addListener('didFocus', () => this.all());
  }
  ...
  createMeeting = async () => {
    ...
    if (userId) {
      ...
      alert(
        `meeting_id:${this.state.meetingId} and password :${this.state.meetingPassword}`,
      );
